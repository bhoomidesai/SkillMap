...
<html>
    <head>
        ...
        <title>Welcome to SkillMapping </title>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="SkillMap/WebContent/WEB-INF/views/registration.jsp"><span class="glyphicon glyphicon-log-in"></span> Registration</a></li>
      <li><a href="SkillMap/WebContent/WEB-INF/views/contact.jsp"><span class="glyphicon glyphicon-user"></span> Contact us</a></li>
    </ul>
  </div>
