...
public class EmployeeTest {
	...
	public void testAddEmployee() {
		...
		employee.setEmployee_name("bhoomi");
		...
		assertEquals(true, employeeService.insertService(employee));
	...
	public void testAddEmployeeFailure() {
		...
		assertEquals(false, employeeService.insertService(employee));
	...
	public void testUpdateEmployee() {
		...
		assertEquals(true, employeeService.updateService(employee));
				
	}
	//@Test
	public void testGetByIDEmployee() {
		
		Employee employee=employeeService.getByIdService(31754);		
		assertEquals("Matched", employeeService.getByIdService(31754).getEmployee_email(),employee.getEmployee_email());
				
	}
	//@Test
	public void testGetAll() {
		
		assertEquals( "Matched", 1,employeeService.getAllService().size());
				
	}
	@Test
	public void testApprove() {
		
		assertEquals(true,employeeService.approveService(31754));
